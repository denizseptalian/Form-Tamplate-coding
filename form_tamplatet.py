...
Original file is located at
    https://colab.research.google.com/drive/108S3c5gF-_zt_s7LH3C1XN9EBZBRLVlj
"""
...
with st.form("pr_form"):
    ...
    if "barang" not in st.session_state:
        st.session_state.barang = [ {"kode":"", "nama":"", "spesifikasi":"", "satuan":"", "qty":1, "harga":0, "keterangan":""} ]
...
if tambah_barang:
    st.session_state.barang.append({"kode":"", "nama":"", "spesifikasi":"", "satuan":"", "qty":1, "harga":0, "keterangan":""})
    st.rerun()
